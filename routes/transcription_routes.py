...
def transcribe_video_openai_small(video: UploadFile):    
...
def transcribe_and_save_audio_openai_small(audio: UploadFile):    
...
def transcribe_and_save_video_openai_small(video: UploadFile):    
